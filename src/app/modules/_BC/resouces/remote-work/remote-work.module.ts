...
@NgModule({
  declarations: [BrowseRemoteWorkComponent, RemoteWorkDialogComponent, RemoteWorkContentComponent],
  imports: [
    CommonModule,
    RemoteWorkRoutingModule,
    NgxsModule.forFeature([BrowseRemoteWorkState]),
