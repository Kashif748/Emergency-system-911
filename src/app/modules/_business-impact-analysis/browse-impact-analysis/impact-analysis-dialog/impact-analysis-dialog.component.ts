...
import { BCAction, BusinessContinuityState } from '@core/states';

@Component({
  selector: 'app-impact-analysis-dialog',
  templateUrl: './impact-analysis-dialog.component.html',
  styleUrls: ['./impact-analysis-dialog.component.scss'],
})
export class ImpactAnalysisDialogComponent implements OnInit {
  ...
  toggleDialog() {
    this.store.dispatch(new BrowseImpactAnalysisAction.ToggleDialog({ dialog :'new_cycle'}));
  }
