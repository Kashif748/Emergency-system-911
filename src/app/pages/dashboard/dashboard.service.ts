      ...
      tap(
        ({
          ...
          this.bcStatistics = {
            ...
            criticalActivities: bcStatistics.criticalActivities ? bcStatistics.criticalActivities + ' - ' + Math.round((bcStatistics.criticalActivities / bcStatistics.totalActivities) * 100) + ' %' : 0
          };
