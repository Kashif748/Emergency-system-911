...
export class LibraryService extends BaseService {
   ...
   */
  static readonly Update30Path = '/v1/library';
  ...
  update30$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, LibraryService.Update30Path, 'put');
    if (params) {
   ...
   */
  static readonly Delete37Path = '/v1/library/{id}';
  ...
  delete37$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, LibraryService.Delete37Path, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
