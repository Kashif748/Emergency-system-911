...
export class LibraryService extends BaseService {
   ...
   */
  static readonly Update29Path = '/v1/library';
  ...
  update29$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, LibraryService.Update29Path, 'put');
    if (params) {
   ...
   */
  static readonly Delete36Path = '/v1/library/{id}';
  ...
  delete36$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, LibraryService.Delete36Path, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
