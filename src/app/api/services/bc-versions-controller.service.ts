...
export class BcVersionsControllerService extends BaseService {
   ...
   */
  static readonly ManageVersionStatusPath = '/v1/bc/version/manage/status/{versionId}/{statusId}';
  ...
  manageVersionStatus$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, BcVersionsControllerService.ManageVersionStatusPath, 'put');
    if (params) {
   ...
   */
  static readonly Update83Path = '/v1/bc/version';
  ...
  update83$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, BcVersionsControllerService.Update83Path, 'put');
    if (params) {
