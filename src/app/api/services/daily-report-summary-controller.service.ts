...
export class DailyReportSummaryControllerService extends BaseService {
   ...
   */
  static readonly Update68Path = '/v1/dailysummaries';
  ...
  update68$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, DailyReportSummaryControllerService.Update68Path, 'put');
    if (params) {
   ...
   */
  static readonly Create62Path = '/v1/dailysummaries';
  ...
  create62$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, DailyReportSummaryControllerService.Create62Path, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
