...
export class AdcdaClassificationControllerService extends BaseService {
   ...
   */
  static readonly Update92Path = '/v1/adcda-classification';
  ...
  update92$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AdcdaClassificationControllerService.Update92Path, 'put');
    if (params) {
   ...
   */
  static readonly Create80Path = '/v1/adcda-classification';
  ...
  create80$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AdcdaClassificationControllerService.Create80Path, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
